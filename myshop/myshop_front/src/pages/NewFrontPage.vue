                    ...
                    <div class="row">
                        ...
                        <div class="swiper-container swiper-slide-gap brand-logo-slider-container">
                            ...
                            <div class="swiper-slide">
                                <!--== Start Brand Logo Item ==-->
                                <div class="brand-logo-item">
                                <a href="shop.html"><img src="@/assets/img/brand-logo/2.jpg" alt="Image-HasTech"></a>
                                </div>
                                <!--== End Brand Logo Item ==-->
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <!--== Start Brand Logo Item ==-->
                                <div class="brand-logo-item">
                                <a href="shop.html"><img src="@/assets/img/brand-logo/5.jpg" alt="Image-HasTech"></a>
                                </div>
                                <!--== End Brand Logo Item ==-->
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <!--== Start Brand Logo Item ==-->
                                <div class="brand-logo-item">
                                <a href="shop.html"><img src="@/assets/img/brand-logo/7.jpg" alt="Image-HasTech"></a>
                                </div>
                                <!--== End Brand Logo Item ==-->
                            </div>
                            </div>
